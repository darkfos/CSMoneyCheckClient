        ...
        const page = (
            <header className="w-11/12 m-auto mt-6">
                <nav className="flex flex-row list-none justify-left items-center gap-12">
                    ...
                    <li></li>
                    <li>
                        <Link to="/" id="main" className={this.colorTheme === "primary" ? this.pageNow === "main" ? "bg-primary_bg rounded-md text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : "text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : this.pageNow === "main" ? "bg-secondary_h_text text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out" : "text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out"} onClick={(e) => {
                            this.setLocaleStorageData("main");
                        }}>Home</Link>
                    </li>
                    <li>
                    <Link to="/docs" id="docs" className={this.colorTheme === "primary" ? this.pageNow === "docs" ? "bg-primary_bg rounded-md text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : "text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : this.pageNow === "docs" ? "bg-secondary_h_text text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out" : "text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out"} onClick={(e) => {
                            this.setLocaleStorageData("docs");
                        }}>Docs</Link>
                    </li>
                    <li>
                    <Link to="/blogs" id="blogs" className={this.colorTheme === "primary" ? this.pageNow === "blogs" ? "bg-primary_bg rounded-md text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : "text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : this.pageNow === "blogs" ? "bg-secondary_h_text text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out" : "text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out"} onClick={(e) => {
                            this.setLocaleStorageData("blogs");
                        }}>Blogs</Link>
                    </li>
                    <li>
                    <Link to="/items" id="items" className={this.colorTheme === "primary" ? this.pageNow === "items" ? "bg-primary_bg rounded-md text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : "text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : this.pageNow === "items" ? "bg-secondary_h_text text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out" : "text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out"} onClick={(e) => {
                            this.setLocaleStorageData("items");
                        }}>Items</Link>
                    </li>
                    <li>
                    <Link to="/reviews" id="reviews" className={this.colorTheme === "primary" ? this.pageNow === "reviews" ? "bg-primary_bg rounded-md text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : "text-primary_text p-3 border-none hover:bg-primary_bg hover:border-2 hover:rounded-md hover:p-3 hover:text-primary_text_hover" : this.pageNow === "reviews" ? "bg-secondary_h_text text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out" : "text-secondary_text text-secondary rounded-md p-3 font-bold hover:bg-secondary_h_text hover:text-primary_text hover:font-bold delay-300 duration-300 transition ease-in-out"} onClick={(e) => {
                    ...
                    <li>
                        {this.colorTheme === "primary" ? <img src={NightThemeIcon} className="w-1/4 hover:scale-125 duration-300 delay-300 cursor-pointer" onClick={(e) => {
                            localStorage.setItem("theme", "secondary");
                            window.location.reload();
                        }}/> : <img src={LightThemeIcon} className="w-1/4 hover:scale-125 duration-300 delay-300 cursor-pointer" onClick={(e) => {
