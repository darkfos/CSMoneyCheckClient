      ...
      <main className="mt-40">
        <div className="grid grid-cols-2 gap-40 items-center w-10/12 m-auto">
          <div className="flex flex-col gap-12">
            <h2 className={colorTheme === "primary" ? "text-primary text-3xl font-bold w-3/4" : "text-secondary_h_text text-3xl font-bold w-3/4"}>Free, Reliable, Scalable
        ...
        <div className={colorTheme === "primary" ? "grid grid-rows-2 mt-40 bg-primary_bg" : "grid grid-rows-2 mt-40"}>
          <header className="w-10/12 m-auto text-center mt-12 flex flex-col gap-4">
            <h3 className={colorTheme === "primary" ? "text-primary_text font-bold text-xl" : "text-secondary_h_text font-bold text-xl"}>#WHATCANIDO</h3>
            <h1 className={colorTheme === "primary" ? "text-3xl text-white font-bold" : "text-secondary_text font-bold text-3xl"}>What can i do in this web app</h1>
            <p className={colorTheme === "primary" ? "text-white font-bold w-9/12 m-auto" : "text-secondary_text font-bold w-9/12 m-auto"}>Discover the Power of Our Marketplace API: Buy and Sell Skins with Ease. Create an Inventory Worth Calculator or Customize Your Gaming Experience with Ingame Skinchanger. Foster Thriving Communities, Build Discord Bots, and Track User Inventories and Profiles. Unleash the Potential of Our Versatile API. </p>
          </header>
          <div className="w-10/12 m-auto flex flex-row gap-8 flex-wrap justify-center -mt-20 pb-8">
            <div className="flex flex-col gap-4 bg-white rounded-2xl w-1/4 p-4">
              <img src={IconCalc} className={colorTheme === "primary"? "w-12 m-auto -mt-9 bg-primary_ac_text p-2 rounded-2xl" : "w-12 m-auto -mt-9 bg-secondary_h_text p-2 rounded-2xl secondary_h_text"}/>
            ...
            <div className="flex flex-col gap-4 bg-white rounded-2xl w-1/4 p-4">
              <img src={IconWeapon} className={colorTheme === "primary"? "w-12 m-auto -mt-9 bg-primary_ac_text p-2 rounded-2xl" : "w-12 m-auto -mt-9 bg-secondary_h_text p-2 rounded-2xl secondary_h_text"}/>
              <h2 className="font-bold">Item data</h2>
              <p>You can create an inventory value calculator similar to csbackpack.net. You can achieve this by using our Steam Profile API and, in addition, the Inventory API. </p>
            </div>
            <div className="flex flex-col gap-4 bg-white rounded-2xl w-1/4 p-4">
              <img src={IconReview} className={colorTheme === "primary"? "w-12 m-auto -mt-9 bg-primary_ac_text p-2 rounded-2xl" : "w-12 m-auto -mt-9 bg-secondary_h_text p-2 rounded-2xl secondary_h_text"}/>
              <h2 className="font-bold">Reviews</h2>
              <p>You can create an inventory value calculator similar to csbackpack.net. You can achieve this by using our Steam Profile API and, in addition, the Inventory API. </p>
            </div>
            <div className="flex flex-col gap-4 bg-white rounded-2xl w-1/4 p-4">
              <img src={IconProfile} className={colorTheme === "primary"? "w-12 m-auto -mt-9 bg-primary_ac_text p-2 rounded-2xl" : "w-12 m-auto -mt-9 bg-secondary_h_text p-2 rounded-2xl secondary_h_text"}/>
              <h2 className="font-bold">Profile</h2>
              <p>You can create an inventory value calculator similar to csbackpack.net. You can achieve this by using our Steam Profile API and, in addition, the Inventory API. </p>
            </div>
            <div className="flex flex-col gap-4 bg-white rounded-2xl w-1/4 p-4">
              <img src={IconBlog} className={colorTheme === "primary"? "w-12 m-auto -mt-9 bg-primary_ac_text p-2 rounded-2xl" : "w-12 m-auto -mt-9 bg-secondary_h_text p-2 rounded-2xl secondary_h_text"}/>
        ...
        <div>
          <header className={colorTheme === "primary" ? "w-10/12 m-auto flex flex-col mt-40 text-center gap-4 justify-items-center" : "w-10/12 m-auto flex flex-col mt-40 text-center gap-4 justify-items-center"}>
            <h2 className={colorTheme === "primary" ? "text-primary font-bold text-3xl" : "text-secondary_h_text font-bold text-3xl"}>Trusted by many users from over 4 countries</h2>
            <p className={colorTheme === "primary" ? "text-primary_text text-xl w-3/5 m-auto" : "text-secondary_text text-xl w-3/5 m-auto"}>Worldwide, Trusted, and Always Present. Our Growing Stats Speak for Themselves, Providing Real and Reliable Insights.</p>
          </header>
          <div className="grid grid-cols-3 gap-1 m-auto w-6/12 mt-12 items-center justify-items-center">
            <div className={colorTheme === "primary" ? "bg-primary_bg w-3/4 text-center p-7 rounded-md text-white font-bold" : "bg-secondary_h_text w-3/4 text-center p-7 rounded-md text-white font-bold"}>
              <h2 className="text-3xl">99.9%</h2>
              <p className={colorTheme === "primary" ? "text-primary_text" : "text-primary_text"}>Uptime</p>
            </div>
            <div className={colorTheme === "primary" ? "bg-primary_bg w-3/4 text-center p-7 rounded-md text-white font-bold" : "bg-secondary_h_text w-3/4 text-center p-7 rounded-md text-white font-bold"}>
              <h2 className="text-3xl">24/7</h2>
              <p className={colorTheme === "primary" ? "text-primary_text" : "text-primary_text"}>Up-to-date</p>
            </div>
            <div className={colorTheme === "primary" ? "bg-primary_bg w-3/4 text-center p-7 rounded-md text-white font-bold" : "bg-secondary_h_text w-3/4 text-center p-7 rounded-md text-white font-bold"}>
              <h2 className="text-3xl">2024</h2>
              <p className={colorTheme === "primary" ? "text-primary_text" : "text-primary_text"}>Trusted since</p>
            </div>
            <div className={colorTheme === "primary" ? "bg-primary_bg w-3/4 text-center p-7 rounded-md text-white font-bold" : "bg-secondary_h_text w-3/4 text-center p-7 rounded-md text-white font-bold"}>
              <h2 className="text-3xl">1</h2>
              <p className={colorTheme === "primary" ? "text-primary_text" : "text-primary_text"}>User</p>
            </div>
            <div className={colorTheme === "primary" ? "bg-primary_bg w-3/4 text-center p-7 rounded-md text-white font-bold" : "bg-secondary_h_text w-3/4 text-center p-7 rounded-md text-white font-bold"}>
              <h2 className="text-3xl">0</h2>
              <p className={colorTheme === "primary" ? "text-primary_text" : "text-primary_text"}>Daily Usage</p>
            </div>
            <div className={colorTheme === "primary" ? "bg-primary_bg w-3/4 text-center p-7 rounded-md text-white font-bold" : "bg-secondary_h_text w-3/4 text-center p-7 rounded-md text-white font-bold"}>
              <h2 className="text-3xl">67949</h2>
              <p className={colorTheme === "primary" ? "text-primary_text" : "text-primary_text"}>Over reviews</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-40 flex flex-col gap-4 w-10/12 m-auto">
          <h2 className={colorTheme === "primary" ? "text-center text-primary font-bold text-3xl" : "text-center font-bold text-3xl text-secondary_h_text"}>Frequently asked questions</h2>
          <div className="flex flex-col gap-2">
            <Accordion className={colorTheme === "primary" ? "accordion_light_theme" : "accordion_night_theme"}>
              <AccordionSummary
        ...
        <div className={colorTheme === "primary" ? "m-auto w-8/12 p-10 bg-primary mt-40 rounded-md flex flex-row gap-20 items-center" : "m-auto w-8/12 p-10 bg-secondary_h_text mt-40 rounded-md flex flex-row gap-20 items-center"}>
          <div className="flex flex-col gap-6">
            <h2 className={colorTheme === "primary" ? "text-white font-bold text-3xl" : "text-secondary_text font-bold text-3xl"}>Ready to dive in?</h2>
